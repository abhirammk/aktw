---
title: "Holomorphic Degree 2 Siegel Modular Forms"
---

### Pari Scripts 

These scripts were written by Abhiram Kidambi. Code to compute Fourier coefficients of holomorphic Siegel modular forms: <a href="../../files/SMF_q-series.zip" download>
...
This will enter the gp shell. 

### Using the pari scripts
...
```
	...
	Printing coefficients up to order lim for weight k=wt Siegel Eisenstein series
